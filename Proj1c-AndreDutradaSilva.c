...
int main(){
    ...
    code[ 30].f = CAL; code[ 30].l = 0; code[ 30].a = 43;
    ...
    code[ 35].f = CAL; code[ 35].l = 0; code[ 35].a = 43;
    code[ 36].f = OPR; code[ 36].l = 0; code[ 36].a = 0;
    code[ 37].f = INT; code[ 37].l = 0; code[ 37].a = 6;
    code[ 38].f = LOD; code[ 38].l = 0; code[ 38].a = 3;
    code[ 39].f = LOD; code[ 39].l = 0; code[ 39].a = 4;
    code[ 40].f = OPR; code[ 40].l = 0; code[ 40].a = 4;
    code[ 41].f = STO; code[ 41].l = 1; code[ 41].a = 7;
    code[ 42].f = OPR; code[ 42].l = 0; code[ 42].a = 0;
    code[ 43].f = INT; code[ 43].l = 0; code[ 43].a = 6;
    code[ 44].f = LOD; code[ 44].l = 0; code[ 44].a = 3;
    code[ 45].f = LOD; code[ 45].l = 0; code[ 45].a = 4;
    code[ 46].f = OPR; code[ 46].l = 0; code[ 46].a = 2;
    code[ 47].f = STO; code[ 47].l = 1; code[ 47].a = 7;
